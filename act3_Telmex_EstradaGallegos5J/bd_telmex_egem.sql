...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2021 a las 05:02:30
...
(6, 'Evelyn Marisol', 'Estrada Gallegos', 7851239245, 'parajes del valle, fortin de la soledad #1307, int', '2004-07-21'),
...
--
ALTER TABLE `usuario`
  MODIFY `NoUsuario` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
